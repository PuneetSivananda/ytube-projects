...
- [Learning Flask](https://pythonise.com/series/learning-flask/flask-cookies)
- [Learning Flask](https://pythonise.com/series/learning-flask/exploring-uwsgi-decorators)
- [Python Learning Paths](https://realpython.com/learning-paths/)
- [Flask app](https://github.com/VergeAnalytics/flask-app/tree/dev)
- [Integrating Bot with BotFrameWork using Node JS , ngrok into MS TEAMS](https://medium.com/@lathasreeseeni/integrating-bot-with-botframework-using-node-js-ngrok-into-ms-teams-bd392b24b2e4)
- [AI-AS-API](https://github.com/datastaxdevs/workshop-ai-as-api)
